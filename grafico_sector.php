      ...
      <div class="col-lg-9 col-xl-10">
        ...
        <div class="card mt-3">
          <div class="card-header">
            <h6><img src="img/report.png" width="35px"></img> INFORMES DEL SISTEMA - PEDIDOS POR SECTOR</h6>
          </div>
          <div class="card-body">
            <hr>
            <div class="text-center">
            <form name="fecha" action="informe_sector.php" method="POST">
            ...
            <!-- INSERTAR GRAFICO DE COLUMNA PARA LA BUSQUEDA DE RANGO DE FECHAS -->
              ...
              <?php
                ...
                $query2="SELECT c.nombre as sector, count(a.id_pedido) as total_pedidos FROM pedido_historico a, cliente b, sector c WHERE a.id_cliente=b.id_cliente AND a.estado=3 and b.id_sector = c.id_sector ";
                  if (trim($fecha1)!="--")
                  {
                  ...
                  $query2=$query2."group BY c.nombre ORDER BY c.nombre";
        ...
        function drawStuff() {
          ...
          data.addRows([
            <?php
              ...
              {
                echo "['".$fila2["sector"]."', ".$fila2["total_pedidos"]."],";
              }
              //['Work',     11]
              ?>    
          ]);
         ...
         var options = {
           title: 'Detalle de cantidades de pedidos divididos por sector',
           width: 750,
           height: 500,
           legend: 'none',
           bar: {groupWidth: '70%'},
